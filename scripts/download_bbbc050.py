"""Opt-in retrieval of the CC BY 3.0 BBBC050 teaching case."""
...
ARCHIVES = ("Images.zip", "GroundTruth.zip")
...
def main() -> None:
    ...
    parser.add_argument(
        "--destination",
        type=Path,
        default=Path("data/external/BBBC050"),
    ...
    print(f"BBBC050 available under {args.destination}")
